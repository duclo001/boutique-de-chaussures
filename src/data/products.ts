...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      ...
      img("derby-shoes_photo2.webp"),
      img("derby-shoes_photo3.webp"),
      img("derby-shoes_photo4.webp"),
      img("derby-shoes_photo5.webp"),
      img("derby-shoes_photo6.webp"),
    ...
    variants: [
      ...
      ...variantesPourCouleur({
        ...
        color: "Gris-Ardoise",
        price: 149.0,
        image: img("derby-shoes_photo2.webp"),
        stockParTaille: 3,
      }),
      ...variantesPourCouleur({
        prefix: "derby-noir-3",
        color: "Noir",
        price: 149.0,
        image: img("derby-shoes_photo3.webp"),
        stockParTaille: 3,
      }),
      ...variantesPourCouleur({
        prefix: "derby-noir-4",
        color: "Marron-Moyen",
        price: 149.0,
        image: img("derby-shoes_photo4.webp"),
        stockParTaille: 3,
      }),
      ...variantesPourCouleur({
        prefix: "derby-noir-5",
        ...
        price: 149.0,
        image: img("derby-shoes_photo5.webp"),
        stockParTaille: 3,
      }),
      ...variantesPourCouleur({
        prefix: "derby-noir-6",
